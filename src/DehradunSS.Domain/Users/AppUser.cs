...
namespace DehradunSS.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DehradunSSDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DehradunSSEfCoreEntityExtensionMappings to extend the IdentityUser entity
